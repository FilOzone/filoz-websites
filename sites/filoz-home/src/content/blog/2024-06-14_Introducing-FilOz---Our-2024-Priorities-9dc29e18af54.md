---
title: Introducing FilOz & Our 2024 Priorities
description: "Molly Mackinlay (@momack2) · Follow & Jennifer Wang (@jennijuju) · Follow - \U0001F30F Read in ChineseJune 4th, 2024"
date: '2024-06-14T15:16:24.507Z'
categories: []
keywords: []
slug: introducing-filoz-our-2024-priorities-9dc29e18af54
featured_image: /images/blog/1__YJKYOdNipuS0HhdoziTIXg.png
---

![](/images/blog/1__YJKYOdNipuS0HhdoziTIXg.png)

Molly Mackinlay (@momack2) · [Follow](https://x.com/momack28) & Jennifer Wang (@jennijuju) · [Follow](https://twitter.com/_jennijuju) — 🌏 [Read in Chinese](https://mp.weixin.qq.com/s/TPB8rkzkgo5kP_ztNwk7nw)  
June 4th, 2024
...
[About Filecoin](https://www.filoz.org/blog/filoz-2024-outlook#h.tg9uptk4dr76)  
[What We Do](https://www.filoz.org/blog/filoz-2024-outlook#h.gsvbltwtbfrz)  
[Filecoin 2024 Priorities](https://www.filoz.org/blog/filoz-2024-outlook#h.j858ogsz90ht)  
[FilOz 2024 Priorities](https://www.filoz.org/blog/filoz-2024-outlook#h.w6cotonyhpva)  
[How to Engage with Us](https://www.filoz.org/blog/filoz-2024-outlook#h.dladsj2w76nr)  
[Funding FilOz](https://www.filoz.org/blog/filoz-2024-outlook#h.ssxw7trh3jr)  
[What’s Next](https://www.filoz.org/blog/filoz-2024-outlook#h.a5pn0h6j19io)

### About Filecoin

Filecoin is a distributed storage network with a mission to create a robust, decentralized, and efficient foundation for humanity’s information. Over the past four years, Filecoin has built the **largest** decentralized storage network in the world, successfully onboarded nearly 2 exabytes of customer data, and grown a massive community of builders, storage providers, and client services. The ecosystem today boasts a rich array of tools, such as [web3.storage](https://web3.storage/), [Lighthouse](https://www.lighthouse.storage/), and [Banyan](https://banyan.computer/), supported by a network of 💙[public goods teams](https://filecoin.io/blog/posts/celebrating-filecoin-public-goods/) contributing to Filecoin OSS development. These teams develop, maintain, and collaborate on improvements to critical codebases, tools, and areas of growth for the Filecoin network.
...
![](/images/blog/0__cVLNW7ykpuVk3Bhf.jpg)
...
![](/images/blog/0__Yh0z2x0bYPyOQRNI.jpg)
...
The plan is to experiment with the new PDP SP interface (as lightweight as possible) in smart contracts _first_ to understand how onramps will leverage PDP for paid services and L2 incentives and then solidify as a FIP in Q3.
...
![](/images/blog/0__Fa72OdYqGwEx6Ziy.jpg)
...
*   🤝 FilOz also hosted 3 [Protocol Days](https://lu.ma/filprotocoldev?tag=protocol%20day) (Aggregators, Filecoin Economy & Data Onramp), network upgrade AMAs, and we plan to host many more. Subscribe [here](https://www.filoz.org/events) for upcoming events!! We are also participating as track leads and organizers for the next [FIL Dev Summit](https://www.fildev.io/) (FDS-4) in Brussels!
...
Our partnerships and collaborations with Filecoin-aligned teams amplify our impact. As a [small team](https://www.filoz.org/team) of senior protocol devs and designers, our energy is best spent by joining forces with others and helping them land valuable improvements to Filecoin through working groups, collaborations, and design partnerships. Engage with us by **dedicating time and resources to make Filecoin better** — and harnessing our team’s expertise to support on design advice, FIP co-authorship, or code reviews to unblock the enhancements you bring to Filecoin.
...
**💙If you’d like to become a FilOz sponsor, please reach out at** [**sponsor@filoz.org**](http://sponsor@filoz.org)**.**

![](/images/blog/0__NyWHMXeSJBGLYjo0.jpg)

### What’s Next

At FilOz, we are committed to enhancing the Filecoin network through collaboration, innovation, and our shared vision for _a decentralized foundation for humanity’s most important information_. Our 2024 priorities reflect our dedication to accelerating storage adoption, enhancing cross-chain interoperability, simplifying maintenance, and expanding the Filecoin economy & community. Together, we can unlock new possibilities and drive the Filecoin mission forward.
