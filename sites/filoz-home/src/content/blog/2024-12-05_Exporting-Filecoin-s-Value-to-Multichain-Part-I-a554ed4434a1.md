...
1.  **Users make a deal** to store data, providing payment and details to a smart contract on their native blockchain.
2.  **Filecoin storage providers accept the deal**, store the data, and generate proofs of storage.
3.  **The proof is returned** to the user’s blockchain via an oracle, which completes the deal and clears payments.

It’s like having a universal interface to plug decentralized storage into any blockchain.

![](/images/blog/1__3n7tiQQjl1LSMVVzRspRdQ.gif)
...
![](/images/blog/1__GE3m7QfV199lV1__R1YwgvQ.gif)
...
[Stay tuned for the next blog](https://medium.com/@filoz/under-the-hood-architecture-and-prototype-of-cross-chain-data-storage-6f8ba2c480d6), where we’ll take a closer look under the hood of the architecture powering cross-chain data storage. If you’re a builder or a Filecoin enthusiast, you won’t want to miss it.

Ready to explore the technical details or experiment with the code? Check out the repository here: [GitHub: Cross-Chain Data On-Ramp](https://github.com/ZenGround0/onramp-contracts).